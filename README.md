...
**[Download the Apple Silicon preview](https://github.com/dion-labs/stream-deck-micro/releases/tag/v0.2.0-alpha.3)** · [Guided setup](https://deck.dionlabs.ai/setup/) · [Install and upgrade notes](docs/native-app.md)
